...
public class MusicService {
    ...
    public List<MusicDetailDTO> ChartList() {
        ...
        List<Object[]> entityList = mrepo.findAlbum(PageRequest.of(0, 30));
    ...
    { try { MusicDetailEntity music = (MusicDetailEntity) mrepo.findByMTitle(mtitle).orElseThrow(() -> new RuntimeException("Music not found")); music.setMLike(music.getMLike() + 1); mrepo.save(music); return true; } catch (Exception e) { return false; } }}
